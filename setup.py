...
def download_release():
    ...
    subprocess.run(
        [
            ...
            f"/tmp/blackbox_exporter-{TARGET_RELEASE}.linux-amd64.tar.gz",
            "--strip-components=1",
            f"blackbox_exporter-{TARGET_RELEASE}.linux-amd64/blackbox_exporter",
        ],
        check=True,
    )
    os.remove(f"/tmp/blackbox_exporter-{TARGET_RELEASE}.linux-amd64.tar.gz")
